...
| POST   | `/v1/projects/{project}/issues/{issue_number}/runs/{run_number}/cycles/{cycle_number}/touchpoint/finalize` | Admin/idempotent finalizer for a review-ready cycle Run, matching the UI run-cycle URL shape. |
