...
always phase so PR/touchpoint materialization is visible in job logs. The current
workflow shape is documented in [`docs/workflow-shape.md`](docs/workflow-shape.md).
