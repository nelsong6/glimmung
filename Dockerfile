...
RUN CGO_ENABLED=0 GOOS=linux go build -trimpath -ldflags="-s -w" -o /out/glimmung-native-runner ./cmd/glimmung-native-runner
...
COPY --from=backend /out/glimmung-native-runner /app/glimmung-native-runner
