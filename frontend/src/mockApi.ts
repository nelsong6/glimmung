    ...
    runs: [{
      ...
      topology: {
	        phases: [
	          ...
	          { name: "touchpoint", kind: "k8s_job", verify: false, always: true, depends_on: ["verify"], jobs: [{ id: "pr-touchpoint", name: "PR touchpoint" }] },
	        ],
      ...
      phases: [
	        ...
	        { name: "touchpoint", kind: "k8s_job", state: "not_started", verify: false, always: true, depends_on: ["verify"], jobs: [{ id: "pr-touchpoint", name: "PR touchpoint", state: "not_started", steps: [{ slug: "ensure-pr-touchpoint", title: "ensure PR touchpoint", state: "not_started" }] }], attempts: [] },
	      ],
      evidence: [
