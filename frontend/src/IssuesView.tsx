                  ...
                  <td>
                    {row.number !== null ? (
                      <Link
                        ...
                        to={issueDetailPath(row.project, row.number)}
                      >
                        {row.title}
                      </Link>
                    ) : (
...
function issueDetailPath(project: string, issueNumber: number): string {
  return `/projects/${encodeURIComponent(project)}/issues/${issueNumber}/summary`;
}
