...
class Settings(BaseSettings):
    ...
    # Kubernetes service-account auth for admin endpoints. Pods presenting
    # their projected SA token (audience kubernetes.default.svc) authenticate
    # via TokenReview against the API server; the resulting username
    # (system:serviceaccount:<ns>:<name>) must be in this allowlist.
    # Comma-separated. See auth.py.
